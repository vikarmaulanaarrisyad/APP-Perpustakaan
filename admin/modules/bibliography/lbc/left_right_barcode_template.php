 ...
 * @create date 2020-08-09 18:48:05
 * @modify date 2020-08-09 18:48:05
 * @desc Label Barcode Left Right template
 */
                    ...
                    foreach ($barcode_arrays as $ky => $barcode) {
                        ...
                        <div class="col">
                            ...
                            <div style="float: left;width: 70px;padding: 5px;">
                                ...
                                <img class="left-barcode barcode" src="<?=SWB?>images/barcodes/<?=$barcode[1]?>.png"/>
                            </div>
                            <!-- Content -->
                            <div class="content">
                            ...
                            <!-- Col barcode left -->
                            <div style="float: left;width: 70px;padding: 5px;">
                                <span class="right-title"><?=substr($barcode[0], 0,20)?></span>
                                <img class="right-barcode barcode" src="<?=SWB?>images/barcodes/<?=$barcode[1]?>.png"/>
                            </div>
                        </div>
                    <?php
                    }
