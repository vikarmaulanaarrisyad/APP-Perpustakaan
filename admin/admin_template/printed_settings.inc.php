...
$sysconf['print']['label']['box_height'] = 5;
...
// label print settings WARNA
/* measurement in cm */
$sysconf['print']['label']['page_margin1'] = 0.1;
$sysconf['print']['label']['items_per_row1'] = 2;
$sysconf['print']['label']['items_margin1'] = 0.09;
$sysconf['print']['label']['box_width1'] = 9.5;
$sysconf['print']['label']['box_height1'] = 8;
$sysconf['print']['label']['include_header_text1'] = 1; // change to 0 if dont want to use header in each label
$sysconf['print']['label']['header_text1'] = ''; // keep empty if you want to use Library Name as a header text
$sysconf['print']['label']['fonts1'] = "Arial, Verdana, Helvetica, 'Trebuchet MS'";
$sysconf['print']['label']['font_size1'] = 11;
$sysconf['print']['label']['border_size1'] = 1; // in pixels

// item barcode print settings
/* measurement in cm */
$sysconf['print']['barcode']['barcode_page_margin'] = 0.1;
$sysconf['print']['barcode']['barcode_items_per_row'] = 2;
$sysconf['print']['barcode']['barcode_items_margin'] = 0.2;
$sysconf['print']['barcode']['barcode_box_width'] = 9;
$sysconf['print']['barcode']['barcode_box_height'] = 8;
$sysconf['print']['barcode']['barcode_include_header_text'] = 0; // change to 0 if dont want to use header in each barcode
$sysconf['print']['barcode']['barcode_cut_title'] = 3; // maximum characters in title to appear in each barcode. change to 0 if you dont want the title cutted
$sysconf['print']['barcode']['barcode_header_text'] = '0'; // keep empty if you want to use Library Name as a header text
...
$sysconf['print']['barcode']['barcode_scale'] = 172; // barcode scale in percent relative to box width and height
